    ...
    def __init__(self):
        ...
        self.subscription = self.create_subscription(
            ...
            10,
                ...
                # Para no spamear la consola cuando faltan articulaciones
        self._missing_joints_reported = set()
    ...
    def joint_state_callback(self, msg: JointState) -> None:
        ...
        for joint_name in JOINT_ORDER:
            if joint_name not in name_to_pos:
                ...
                # Solo avisamos una vez por articulación faltante para no llenar la consola.
                if joint_name not in self._missing_joints_reported:
                    self.get_logger().warn(
                        f"Esperando todas las articulaciones en /joint_states. Falta: {joint_name}"
                    )
                    self._missing_joints_reported.add(joint_name)
                return
